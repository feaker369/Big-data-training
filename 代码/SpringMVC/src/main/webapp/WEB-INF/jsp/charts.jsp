...
<body>
    <table class="chart_table">
        <tr>
            ...
            <td style="min-width: 300px; margin: 0px; padding: 0px;">
                <table class="table">
                    <tr>
                        <th style="width: 100px;">学历要求详情</th>
                        <th style="width: 100px;">公司规模详情</th>
        ...
        <tr>
            ...
            <td style="min-width: 300px; margin: 0px; padding: 0px;">
                <table class="table">
                    <tr>
                        <th style="width: 100px;">学历要求详情</th>
                        <th style="width: 100px;">招聘情况详情</th>
                        <th style="width: 100px;">人数</th>
                    </tr>
    ...
    <table class="table">
        <tr>
            ...
            <th style="width: 100px;">工作经验等级</th>
            <th style="width: 100px;">第二职位类型</th>
            <th style="width: 100px;">平均工作经验</th>
        </tr>
